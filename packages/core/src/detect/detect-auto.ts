...
function getApiKey(): string | null {
  ...
  if (typeof window !== 'undefined' && (window as { __BEACIO_KEY__?: string }).__BEACIO_KEY__) {
    return (window as { __BEACIO_KEY__?: string }).__BEACIO_KEY__ ?? null;
  }
...
function getOperatorName(): string | undefined {
  ...
  if (typeof window !== 'undefined' && (window as { __BEACIO_NAME__?: string }).__BEACIO_NAME__) {
    return (window as { __BEACIO_NAME__?: string }).__BEACIO_NAME__;
  }
  return undefined;
}
