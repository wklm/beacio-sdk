...
import * as banner from '../src/banner';
...
const BEACIO_DEFAULT_BODY =
  'To connect to your device, install beacio, open the app once, enable the Safari extension, allow access on this site, then return to {operator}.';
