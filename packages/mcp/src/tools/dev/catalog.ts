...
export const CATALOG: CatalogEntry[] = [
  // ── Docs facet (formerly DOC_INDEX) ──────────────────────────────────────
  {
    ...
    snippet:
      'Install @ios-web-bluetooth/core and add the polyfill to your web app. Works on iOS Safari with the WebBLE extension.',
  ...
  },
  {
    ...
    snippet:
      'The WebBLE class provides requestDevice, getAvailability, and platform detection. Entry point for all BLE operations.',
  ...
  },
  {
    ...
    snippet:
      'WebBLEDevice wraps BluetoothDevice with connect, disconnect, read, write, subscribe, and notifications methods.',
  ...
  },
  {
    ...
    snippet:
      'WebBLEError provides typed error codes (DEVICE_NOT_FOUND, GATT_OPERATION_FAILED, etc.) with recovery suggestions.',
  ...
  },
  {
    ...
    snippet:
      '@ios-web-bluetooth/react provides WebBLEProvider, useWebBLE, useDevice, useNotifications hooks, and ready-made UI components.',
  ...
  },
  {
    ...
    snippet:
      '@ios-web-bluetooth/profiles ships HeartRateProfile, BatteryProfile, DeviceInfoProfile plus defineProfile for custom BLE profiles.',
  ...
  },
  {
    ...
    snippet:
      '@ios-web-bluetooth/detect adds an automatic install banner on iOS Safari when the WebBLE extension is not installed.',
  ...
  },
  {
    ...
    snippet:
      'Complete reference of WebBLEError codes: BLUETOOTH_UNAVAILABLE, EXTENSION_NOT_INSTALLED, DEVICE_NOT_FOUND, and more with fixes.',
  ...
  },
  {
    ...
    snippet:
      '@ios-web-bluetooth/testing provides mock BLE devices, mock navigator.bluetooth, and helpers for unit/integration testing.',
