import { readUint8, readUint16LE, clampPercent, type Percentage, type NativeOverflowEvent } from '@beacio/core';
 ...
 * @example
 * ```ts
 * import { StorzBickelProfile } from '@beacio/profiles/storz-bickel';
 *
