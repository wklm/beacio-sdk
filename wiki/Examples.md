...
2. Build a basic scan and connect flow from [Core SDK](Core-SDK)
3. Add install prompts from [Extension Detection](Extension-Detection)
4. Add React hooks from [React SDK](React-SDK) if needed
5. Add alerts from [Background Sync](Background-Sync) only after the core flow works
